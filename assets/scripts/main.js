...
function addRecipesToDocument(recipes) {
  ...
  for (let i = 0; i < recipes.length; i++) {
    let recipea = document.createElement('recipe-card');
    recipea.data = recipes[i];
    mains.appendChild(recipe);
  }
}
...
function initFormHandler() {
  ...
  let forma = document.getElementById('new-recipe');
  ...
  //let clearLocalbutton = document.querySelector('button');
  // B11. TODO - Add a click event listener to clear local storage button
  //clearLocalbutton.addEventListener('click', function(event) {
